/**
 * Created by Mehmet Ali Peker on 29.12.2016.
 */
tinymce.PluginManager.add('smileys', function (editor,url) {
    ...
    function replaceAllMatches(smiley) {
        ...
        if (typeof (smiley.shortcut) === 'string') {
            ...
            marker = editor.dom.create('img', { "src": smiley.url,"data-mce-src": smiley.url, "title": smiley.title });
    ...
    editor.addButton('smileys', {
        ...
        panel: {
            ...
            onclick: function (e) {
                ...
                if (linkElm) {
                    editor.insertContent('<img src="' + linkElm.getAttribute('data-mce-src') + '" title="' + linkElm.getAttribute('title') + '" />');
                    this.hide();
                }
            }
        },
